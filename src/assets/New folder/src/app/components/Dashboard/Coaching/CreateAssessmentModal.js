                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex alignCenter">
                                                        ...
                                                        <div>
                                                            <div>
                                                                <div className="font14 bold600">
                                                                    {title}
                                                                </div>
                                                                <div className="dusty_gray_cl font12">
                                                                    {
                                                                        "Created on "
                                                                    }
                                                                    {getDateTime(
                            ...
                            onClick={() => {
                                ...
                                dispatch(
                                    createAssesment({
                                        ...
                                        assessment_id: activeAssessment,
                                    })
                                ).then((res) => {
                                    dispatch(
                                        getCoachingSessionList(filtersPayload)
                                    );
                                });
                            }}
                            style={{
