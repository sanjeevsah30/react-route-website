...
import { GEO_COLOR_RANGE } from "./helper.js";
...
const US_TOPO_JSON = require("./us.topo.json");
...
function IndiaChoroPleth() {
    ...
    const gradientData = {
        fromColor: GEO_COLOR_RANGE[0],
        toColor: GEO_COLOR_RANGE[GEO_COLOR_RANGE.length - 1],
        min: 0,
        max: data.reduce(
